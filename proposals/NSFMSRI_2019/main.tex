...
\comment{modify the motivation here to reflect our funding request; move
away from being LSST centric}
...
physical information.  FOBOS will provide a rich set of similar
...
epoch.  Targeted followup with FOBOS will allow us to ascribe
...
define requirements for FOBOS instrument performance and the \comment{FOBOS
Public Survey} design.
...
Lyman continuum radiation observed in the \comment{FOBOS Public Survey} to
...
spec-$z$s on spectra obtained in just 10 minutes with FOBOS.  This
...
compelling sub-component of the \comment{FOBOS Public Survey}.
