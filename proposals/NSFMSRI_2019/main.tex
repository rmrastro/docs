...
is currently providing a revolution in our understanding of our own
galaxy, providing distances and three-dimensional motions for more than
a billion stars spanning the full extent of the Milky Way's disk.


in terms of the detail to
which we can study their content.

by virtue of .

Although only one realization of the dynamically bound small groups of
galaxies in the Local Volume, we can study our own Local Group in elaborate detail,
including the Milky Way, and Andromeda and Triangulum galaxies, as well
as many smaller satellites, both star-forming (LMC, SMC) and not
star-forming (M32, Fornax and other dSphs).

Nothing exemplifies this more than the current data coming from GAIA.
Although GAIA will not get chemical abundances for stars outside X pc
from the sun.  Follow-up programs like WEAVE and 4MOST aim to build up
radial velocities.  Can use FOBOS to go deeper, specifically in the disk
where the target densities are high.  Similar to photo-zs, idea would be
to build up the radial velocity sample at the faint end of the GAIA
surface brightness limit.  Chemical tagging.

SDSS revolutionized our census of the local group, allowing us to locate
ultra-faint dwarf satellites of the Milky Way, in effect solving the
"missing satellites" problem.  LSST will likely reveal hundreds more of
these satellites.


\medskip
\noindent {\bf Data Science Challenge \comment{x}: Dynamics of newly discovered Ultra-Faint dwarfs.}

\medskip
\noindent {\bf Data Science Challenge \comment{x}: Chemodynamical tagging Dynamics of newly discovered Ultra-Faint dwarfs.}
