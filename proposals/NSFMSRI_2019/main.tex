...
Infrared Survey Telescope (WFIRST), Euclid, and other facilities to address key questions in the areas of Dark Energy,
the galaxy ecosystem at $z\sim2$, and the assembly history of the Milky Way and Local Group Galaxies.  We will design
the astrostatistics, instrumentation, and software solutions required over the next decade to provide optimized
...
requirements will guide the preliminary design of Keck-FOBOS, a powerful new spectrograph to deploy in 2026 on the 10 m
Keck II Telescope.  Keck-FOBOS will provide publicly-available deep, high-multiplex spectroscopy with high target
