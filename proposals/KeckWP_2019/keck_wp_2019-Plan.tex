...
The work proposed here complements ongoing FOBOS development efforts in preparation of a future NSF MSIP proposal.  We will complete a full FOBOS conceptual design and focus design efforts on sub-systems we believe are the highest risk: Starbugs fiber positioners, fiber fore-optics, and the calibration system.  This work will enable instrument performance evaluations against proposed science use cases as well as initial total cost estimates.  To support this effort, we request:
